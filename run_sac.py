...
if __name__ == '__main__':
    ...
    for i_episode in itertools.count(1):
        ...
        if total_numsteps > args.num_steps or episode_reward > args.limit:
            break
    ...
    # save memory
    # memory.save("{}_SAC_{}_{}".format(args.buffer_type, args.env_name, args.seed))

    # save model
    agent.save_model(args.env_name, suffix='{}.pkl'.format(args.buffer_type))
